...
Mirror& GetMirror4()
{
static Mirror GM4(&GetMirror3());//Creating depenceny of GM2 on the GM whose initalization is dependent on the order in which the translation units are assembled
return GM4;
}
