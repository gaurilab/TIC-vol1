...
Mirror& GetMirror2()
{
static Mirror GM2(&GetMirror1());//Creating depenceny of GM2 on the GM whose initalization is dependent on the order in which the translation units are assembled
return GM2;
}
