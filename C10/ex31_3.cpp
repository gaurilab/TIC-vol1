...
Mirror& GetMirror3()
{
static Mirror GM3(&GetMirror2());//Creating depenceny of GM2 on the GM whose initalization is dependent on the order in which the translation units are assembled
return GM3;
}
